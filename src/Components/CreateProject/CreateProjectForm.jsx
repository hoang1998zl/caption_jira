        ...
        <div className="w-full mb-4 border border-gray-200 rounded-lg bg-gray-50 dark:bg-gray-700 dark:border-gray-600">
          ...
          <div className="px-2.5 py-2 bg-white rounded-b-lg dark:bg-gray-800">
            ...
            <textarea
              id="description"
              rows="8"
              className="focus:outline-none block w-full px-0 text-gray-800 bg-white border-0 dark:bg-gray-800 focus:ring-0 dark:text-white dark:placeholder-gray-400 start"
              onChange={(e) => {
