    ...
    >
        ...
        <input
          ...
          onChange={(e) => {
            if (e.target.value === password) {
              ...
              document.getElementById('signin_btn').style.cursor = 'auto';
              document.getElementById('comfirmPassword').style.borderColor = 'rgb(209 213 219)';
            } else {
              document.getElementById('signin_btn').disabled = true;
              document.getElementById('signin_btn').style.cursor = 'not-allowed';
              document.getElementById('comfirmPassword').style.borderColor = 'red';
            }
          }}
        />
        <button
      ...
      >
        <button
          id='signin_btn'
          type="submit"
          disabled={email === '' || password === '' || confirmPassword === '' || password !== confirmPassword || name === '' || phoneNumber === '' ? true : false}
